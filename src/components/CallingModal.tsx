    ...
    >
      ...
      <div className="p-4 space-y-4">
        <div className="relative flex flex-col space-y-2 cursor-move">
          ...
          <p style={{ fontSize: '0.625rem', color: '#6B7280', opacity: isConnecting ? 0.5 : 1 }}>AI can make mistakes. Please double-check responses.</p>
          <div className="flex justify-between items-center" style={{ opacity: isConnecting ? 0.5 : 1 }}>
